...
import com.team5.catdogeats.global.annotation.AuthenticatedUser;
...
/**
 * 판매자용 주문 관리 컨트롤러
 * 판매자가 본인이 판매한 상품의 배송지 정보를 조회할 수 있는 API를 제공합니다.
 */
@Slf4j
@RestController
...
public class SellerOrderController {
    ...
    public ResponseEntity<SellerOrderDetailResponse> getSellerOrderDetail(
            @AuthenticatedUser UserPrincipal userPrincipal,
