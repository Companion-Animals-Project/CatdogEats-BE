...
import com.team5.catdogeats.batch.mapper.ReviewClassificationLLMDogHandmadeBatchMapper;
...
@Component
@StepScope
public class ReviewSummaryItemWriterDogHandmade implements ItemWriter<ReviewSummaryResult> {
    private final ReviewSummaryLLMBatchMapper summaryMapper;
    private final ReviewClassificationLLMDogHandmadeBatchMapper classificationMapper;

    public ReviewSummaryItemWriterDogHandmade(ReviewSummaryLLMBatchMapper summaryMapper,
                                              ReviewClassificationLLMDogHandmadeBatchMapper classificationMapper) {
        ...
        try {
            for (ReviewSummaryResult result : items) {
                ...
                for (ReviewClassificationResultDto dto : result.classificationResults()) {
                    ReviewClassificationLLMDogHandmade entity = ReviewClassificationLLMDogHandmade.builder()
