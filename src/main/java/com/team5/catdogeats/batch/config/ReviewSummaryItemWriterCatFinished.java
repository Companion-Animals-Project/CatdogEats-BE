...
import com.team5.catdogeats.batch.mapper.ReviewClassificationLLMCatFinishedBatchMapper;
...
@Component
@StepScope
public class ReviewSummaryItemWriterCatFinished implements ItemWriter<ReviewSummaryResult> {
    private final ReviewSummaryLLMBatchMapper summaryMapper;
    private final ReviewClassificationLLMCatFinishedBatchMapper classificationMapper;

    public ReviewSummaryItemWriterCatFinished(ReviewSummaryLLMBatchMapper summaryMapper,
                                              ReviewClassificationLLMCatFinishedBatchMapper classificationMapper) {
        ...
        try {
            for (ReviewSummaryResult result : items) {
                ...
                for (ReviewClassificationResultDto dto : result.classificationResults()) {
                    ReviewClassificationLLMCatFinished entity = ReviewClassificationLLMCatFinished.builder()
