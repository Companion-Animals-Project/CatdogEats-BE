...
import com.team5.catdogeats.batch.mapper.ReviewClassificationLLMDogFinishedBatchMapper;
...
public class ReviewSummaryItemWriterDogFinished implements ItemWriter<ReviewSummaryResult> {
    ...
    private final ReviewClassificationLLMDogFinishedBatchMapper classificationMapper;

    public ReviewSummaryItemWriterDogFinished(ReviewSummaryLLMBatchMapper summaryMapper,
                                              ReviewClassificationLLMDogFinishedBatchMapper classificationMapper) {
        ...
        try {
            for (ReviewSummaryResult result : items) {
                ...
                for (ReviewClassificationResultDto dto : result.classificationResults()) {
                    ReviewClassificationLLMDogFinished entity = ReviewClassificationLLMDogFinished.builder()
