...
public class BatchExecutionStatus {
     ...
     * 배치 시작 상태로 변경
     */
    public BatchExecutionStatus markAsRunning(String executionId) {
     ...
     * 배치 완료 상태로 변경
     */
    public BatchExecutionStatus markAsCompleted() {
        return BatchExecutionStatus.builder()
                .id(this.id)
                .batchName(this.batchName)
     ...
     * 배치 실패 상태로 변경
     */
    public BatchExecutionStatus markAsFailed() {
        return BatchExecutionStatus.builder()
                .id(this.id)
                .batchName(this.batchName)
     ...
     * 대기 상태로 초기화
     */
    public BatchExecutionStatus markAsIdle() {
        return BatchExecutionStatus.builder()
                .id(this.id)
                .batchName(this.batchName)
