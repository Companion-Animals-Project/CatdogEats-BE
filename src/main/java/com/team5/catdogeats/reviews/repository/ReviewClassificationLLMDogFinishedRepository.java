...
public interface ReviewClassificationLLMDogFinishedRepository extends JpaRepository<ReviewClassificationLLMDogFinished, String> {
    @Modifying
    @Query("DELETE FROM ReviewClassificationLLMDogFinished r WHERE r.product = :product")
